...
def upgrade() -> None:
    op.create_table(
        ...
        sa.Column("filled_avg_price", sa.Numeric(28, 8), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column("id", sa.Integer(), primary_key=True, nullable=False),
        sa.Column("user_id", sa.Integer(), nullable=False),
        sa.Column("daily_loss_limit_pct", sa.Numeric(28, 8), nullable=False),
        sa.Column("updated_at", sa.DateTime(), nullable=False),
        sa.ForeignKeyConstraint(["user_id"], ["user.id"]),
    )
    ...
    op.create_table(
        ...
        sa.Column("opening_equity", sa.Numeric(28, 8), nullable=False),
        sa.Column("created_at", sa.DateTime(), nullable=False),
        sa.ForeignKeyConstraint(["user_id"], ["user.id"]),
    )
