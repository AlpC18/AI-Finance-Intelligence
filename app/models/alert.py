...
class Alert(SQLModel, table=True):
    ...
    condition_type: str
    threshold_value: Optional[Money] = Field(default=None, max_digits=MONEY_DIGITS, decimal_places=MONEY_PLACES)  # unused for AI_SIGNAL_STRONG_BUY
...
class AlertCreate(BaseModel):
    ...
    threshold_value: Optional[Money] = None
    is_active: bool = True
...
class AlertRead(BaseModel):
    ...
    symbol: str
    condition_type: ConditionType
    threshold_value: Optional[Money]
    is_active: bool
    created_at: datetime
